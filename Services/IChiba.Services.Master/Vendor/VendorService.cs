...
namespace IChiba.Services.Master
{
    public partial class VendorService : IVendorService
    {
        ...
        {
            _vendorRepository = EngineContext.Current.Resolve<IRepository<Vendor>>(DataConnectionHelper.ConnectionStringNames.Master);
        ...
        public virtual async Task<int> InsertAsync(Vendor entity)
        {
            if (entity == null)
            ...
            await _cacheManager.HybridProvider.RemoveByPrefixAsync(MasterCacheKeys.Vendors.PrefixCacheKey);

            return result;
        }

        public virtual async Task<int> UpdateAsync(Vendor entity)
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public virtual IList<Vendor> GetAll(bool showHidden = false)
        {
            var key = MasterCacheKeys.Vendors.AllCacheKey.FormatWith(showHidden);
        ...
        public virtual IPagedList<Vendor> Get(VendorSearchContext ctx)
        {
        ...
        public virtual async Task<Vendor> GetByIdAsync(string id)
        {
            if (id.IsEmpty())
                return null;
